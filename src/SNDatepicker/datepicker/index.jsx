...
export default class DatePicker extends React.Component {
    static propTypes = {
        ...
        onKeyDown: PropTypes.func, // return bool
    ...
    handleChangeValueDate = (date) => {
        if (date)
            this.setSelected(date, null, true);
    };
    ...
    renderDateInput = () => {
        ...
        return React.cloneElement(customInput, {
            ...
            value: inputValue,
            valueDate: this.props.selected,
            setOpen: this.setOpen, // CUSTOM CODE
            isOpen: this.isOpen, // CUSTOM CODE
            onBlur: this.handleBlur,
            onChange: this.handleChange,
            onChangeValueDate: this.handleChangeValueDate, // CUSTOM CODE
