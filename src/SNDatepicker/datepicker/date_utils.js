...
export function allDaysDisabledBefore(day,
                                      unit,
...
export function allDaysDisabledAfter(day,
                                     unit,
...
export function getHightLightDaysMap(highlightDates = [],
...
export function timeToInjectAfter(startOfDay,
                                  currentTime,
                                  currentMultiplier,
                                  intervals,
                                  injectedTimes) {
